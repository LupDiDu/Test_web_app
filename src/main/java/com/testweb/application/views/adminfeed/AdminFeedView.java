package com.testweb.application.views.adminfeed;
...
@PageTitle("AdminFeed")
@Route(value = "feed2", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdminFeedView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public AdminFeedView() {
        addClassName("admin-feed-view");
        setSizeFull();
        grid.setHeight("100%");
