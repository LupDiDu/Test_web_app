package com.testweb.application.views.booklibrary;

import com.testweb.application.data.SampleBook;
import com.testweb.application.services.SampleBookService;
import com.testweb.application.views.MainLayout;
...
@PageTitle("BookLibrary")
@Route(value = "BookLibrary/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class BookLibraryView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "BookLibrary/%s/edit";
    ...
    public BookLibraryView(SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("book-library-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(BookLibraryView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(BookLibraryView.class);
            }
        }
    }
